...
(function() {
  var Game, Lander, Rocket, RotationalSprite, atlas, atlas_h, atlas_w, b2Scale, countedCallback, exhaustFrameUvs, face3, face4, jsonLoader, landerFrameUvs, launch, pushFaces, pushVertices, rocketFrameUvs, terrainSurface, vector2, vertex, zeroFill,
  ...
  global.camera = new THREE.OrthographicCamera(-window.global.width / 4, window.global.width / 4, -window.global.height / 4, window.global.height / 4, -10, 3000);
  ...
  $.getJSON('js/textures.json', {}, countedCallback(function(data) {
    ...
    _ref = [["lander", landerFrameUvs, 100], ["rocket", rocketFrameUvs, 100], ["exhaust", exhaustFrameUvs, 25]];
    _results = [];
  ...
  Game = (function() {
    ...
    function Game() {
      ...
      this.debugMesh = new THREE.Mesh(this.debugGeometry, global.landerMaterial);
    }
  ...
  RotationalSprite = (function() {
    ...
    RotationalSprite.prototype.update = function(dt) {
      ...
      if (this.atlasUvs.length > 0) {
        ...
        frame = Math.floor(signedMod(a / Math.PI / 2 * 100 + this.angleOffset, 100));
  ...
  Lander = (function(_super) {
    ...
    function Lander(game) {
      ...
      this.exhaustCycle = 0;
      global.scene.add(this.exhaustMesh);
    }
    ...
    Lander.prototype.update = function(dt) {
      var a, f, frame, h, p1, thrust, v, w, x, y;
      x = this.body.GetPosition().x / b2Scale;
      y = this.body.GetPosition().y / b2Scale;
      a = this.body.GetAngle();
      this.body.m_torque = 2000000 * dt * this.steering;
      this.exhaustStrength += (this.thrust ? 1 : -1) * 3 * dt;
      ...
      this.exhaustMesh.position.z = -40;
